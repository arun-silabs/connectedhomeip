...
#define CHIP_PTFM_ERROR(part, code) (::chip::ChipError(::chip::ChipError::MapPlatformError(part, code)))
...
#define CHIP_PLATFORM_ERROR(e) CHIP_PTFM_ERROR(::chip::ChipError::Range::kPlatform, (e))
